...
function setup() {
	...
	rope2 = new Rope(bob2.body, pivot.body, 50, 0);``
	rope3 = new Rope(bob3.body, pivot.body, -50, 0);``
	rope4 = new Rope(bob4.body, pivot.body, -100, 0);``
	rope5 = new Rope(bob5.body, pivot.body, 100, 0);``
